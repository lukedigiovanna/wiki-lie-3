    ...
    <>
      <Popover visible={popovers.showRoundSummary()} close={() => { popovers.setShowRoundSummary(false) }}>
        ...
        <div class="flex flex-col items-center">
          <a class="text-center font-bold text-blue-500 underline hover:text-purple-500 active:text-purple-800 transition text-[1.75rem] font-[Libertine]" href={getWikipediaURL(popovers.roundSummary().article)} title="open in wikipedia" target="_blank" >
